...
# параметры для подключения к БД PostgreSQl в докере (на локальном сервере)
...
# параметры для подключения к БД PostgreSQL в облачном сервисе
postgresql_settings = {
    'user': 'student',
    'password': 'de-student',
...
TOPIC_IN = 'student.topic.cohort15.kirillzhul_in'
TOPIC_OUT = 'student.topic.cohort15.kirillzhul_out'
